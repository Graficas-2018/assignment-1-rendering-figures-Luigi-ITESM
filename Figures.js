...
function createSphere(gl, radius)
{
    ...
    // First we need to identify the beginning point that is going to be (0,0,0) always
    // Then the next point to join the line will be PI/180 * a degree and this will be converted to polar units
